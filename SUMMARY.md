...
* [Commands in TPY](command-in-tpy.md)
...
* [Tips, Best Practices & Troubleshooting](tips-best-practices-and-troubleshooting.md)
* [FAQ](frequently-asked-questions-faqs.md)
* [Glossary & Key Concepts](glossary-and-key-concepts.md)

## Changelog
* [Telegram Bot API 10.1 — Gifts, Stories, Business, Checklists & Stars](telegram-bot-api-10.1-update.md)
* [Version 7.1.2 — Security Library, Webhook Headers & IP](version-7.1.2-update.md)
* [Version 5.0.0 — Stats, TransferData, OpenRouter AI](version-5.0.0-update.md)
* [Version 4.9.0 — TON, time.sleep(), Extended Timeouts](version-4.9.0-update.md)
* [Version 4.8.0 — Account Class, Bot Recovery](version-4.8.0-update.md)
* [Version 4.7.0 — OpenAI, Gemini AI, adminRes](version-4.7.0-update.md)
